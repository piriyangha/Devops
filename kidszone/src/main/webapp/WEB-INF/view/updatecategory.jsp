...
<body>
	...
	<c:url value="/all/category/updatecategory" var="url"></c:url>
</head>
...
<springForm:form action="${url}" method="POST" modelAttribute="cat" class="form-horizontal">
            ...
            <div class="row">
                <div class="form-group col-md-12">
                   <springForm:label class="control-label col-sm-4"
                    ...
                    <div class="col-md-7">
                       <springForm:input path="cname" class="form-control" value="${cat.cname}"/>
